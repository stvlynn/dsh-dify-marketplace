 ...
 */
export function categoryMapping(category) {
 ...
 */
export function projectedToolNames(detail) {
 ...
 */
export function projectedToolNamesFromSnapshot(org, name, category, projection) {
    switch (category) {
        case 'tool':
...
export const DATASOURCE_OPERATIONS = ['browse', 'fetch'];
/** Operations the trigger adapter registers for every trigger plugin. */
export const TRIGGER_OPERATIONS = ['subscribe', 'unsubscribe'];
/**
 ...
 */
export function modelOperations(detail) {
...
export const MODEL_TYPE_OPERATIONS = {
    'llm': 'llm',
