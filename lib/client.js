			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					detail.credentialFields.length > 0 && (0, react_jsx_runtime.jsxs)("form", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("p", { children: t("credentialsHint") }),
							detail.credentialFields.map((field) => (0, react_jsx_runtime.jsxs)("div", {
